...
class DataFormats {
  static const full = "yyyy-MM-dd HH:mm:ss";
  static const y_mo_d_h_m = "yyyy-MM-dd HH:mm";
  static const y_mo_d = "yyyy-MM-dd";
  static const y_mo = "yyyy-MM";
  static const mo_d = "MM-dd";
  static const mo_d_h_m = "MM-dd HH:mm";
  static const h_m_s = "HH:mm:ss";
  static const h_m = "HH:mm";
  static const m_s = "mm:ss";

  static const zh_full = "yyyy年MM月dd日 HH时mm分ss秒";
  static const zh_y_mo_d_h_m = "yyyy年MM月dd日 HH时mm分";
  static const zh_y_mo_d = "yyyy年MM月dd日";
  static const zh_y_mo = "yyyy年MM月";
  static const zh_mo_d = "MM月dd日";
  static const zh_mo_d_h_m = "MM月dd日 HH时mm分";
  static const zh_h_m_s = "HH时mm分ss秒";
  static const zh_h_m = "HH时mm分";
}
